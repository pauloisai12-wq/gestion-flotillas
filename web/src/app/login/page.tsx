      ...
      <Card className="relative w-full max-w-md p-8">
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-muted-foreground">Sala de control</span>
          </div>
          <h1 className="text-2xl font-semibold tracking-tight text-foreground">Flotillas</h1>
          <p className="text-sm text-muted-foreground mt-1">Plataforma B2B de gestión vehicular</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="admin@flotillas.com"
              autoComplete="email"
            />
          </div>
